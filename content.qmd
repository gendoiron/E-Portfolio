...
![](cable_bay_maps/Alternative_layout_022025 conv 1.png)
...
**Key Methods: - LiDAR and imagery processing in R - Raster manipulation in ArcGIS - Random Forest Classification in Python**
...
Red represents broadleaf trees, yellow represents the conifers, and blue is the water and green is for other (mostly barren land and grassy meadows).
